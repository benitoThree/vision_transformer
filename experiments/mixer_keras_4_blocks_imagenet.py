...
run_experiment(
    ...
    test_data_path="",
    n_classes=1000,
    save_path="/home/benito/vision_transformer/experiments/mixer_keras_4_blocks_imagenet",
    logfile_path="/home/benito/vision_transformer/experiments/mixer_keras_4_blocks_imagenet.log",
    n_mixer_blocks=4,
